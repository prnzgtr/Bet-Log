...
.ps-card:hover { border-color: var(--bdh);  }
                        ...
                        <div class="ps-card">
                            <div class="ps-card-head">
                                ...
                                <div>
                                    ...
                                    <div class="ps-card-sub">Change your password and set a security question</div>
                                </div>
                            </div>
                            <div class="ps-card-body">
                                <div class="ps-fg ps-fg-2">
                    ...
                    <div class="ps-side">
                        ...
                        <div class="ps-widget">
                            ...
                            <div class="ps-widget-body">
                                <div class="ps-row">
                                    <span class="ps-row-k">User ID</span>
                                    <span class="ps-row-v" style="font-family:var(--fm);color:var(--cy);">#<?php echo htmlspecialchars($user['id']); ?></span>
                                </div>
                                <div class="ps-row">
