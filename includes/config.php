...
// FIX: Changed from 'Lax' to 'Strict' for better CSRF protection.
// If your site is on HTTPS, also change cookie_secure to 1.
ini_set('session.cookie_secure', 0);       // ← Change to 1 when on HTTPS
ini_set('session.use_only_cookies', 1);
ini_set('session.cookie_samesite', 'Strict'); // FIX: was 'Lax'
