<?php
// FIX: Active state now works for ALL sidebar items, not just Home
...
// FIX: Define active pages for each sidebar item
...
<aside class="sidebar">
    ...
    <div class="sidebar-section">
        ...
        <ul class="sidebar-menu">
            <li>
                <!-- FIX: demo.php, aviator.php, slot.php all highlight Demo Casino -->
