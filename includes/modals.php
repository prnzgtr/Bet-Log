<!-- ============================================================
     includes/modals.php  — Login + Register + Forgot Password
     ============================================================ -->
...
<style>
/* ================================================================
   REGISTER MODAL — Multi-step redesign
   ================================================================ */
.reg-modal-content {
...
/* ================================================================
   FORGOT PASSWORD MODAL (unchanged styles)
   ================================================================ */
.fp-modal {
...
function regShowPanel(step) {
    ...
    [1, 2, 3].forEach(i => {
        ...
        if (ind.classList.contains('done')) {
            span.textContent = '';   // CSS ::before handles checkmark
        } else {
            span.textContent = i;
        }
    });
...
async function handleRegister(e) {
    ...
    try {
        ...
        if (data.success) {
            // Show success then switch to login modal
            showRegisterError('');
            hideRegisterError();
            closeModal('registerModal');
            // Small delay then open login with success hint
            setTimeout(() => {
