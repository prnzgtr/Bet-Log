<?php
// ajax/credits_balance.php
// Returns the user's current demo credit balance, completion status, and recent transactions.
...
try {
    ...
    // Daily claim status — check only, no auto-award
    // Actual awarding is handled by credits_daily_claim.php
    $today            = date('Y-m-d');
