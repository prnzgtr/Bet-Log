...
try {
    // Auto-create tables if migration hasn't been run yet
    ...
    // Add demo_credits column if it doesn't exist
    try {
    ...
    // Check all-content bonus (4 lessons + 1 myths = 5 completions)
    $bonusAwarded = false;
    $bonusAmount  = 0;
