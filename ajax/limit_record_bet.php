<?php
// ajax/limits_record_bet.php
// Records a bet outcome and updates the user's usage counters.
// Call this AFTER a bet is placed and the result is known.
// POST body: { game_type, bet_amount, outcome, pnl }
...
$outcome   = $input['outcome']    ?? 'pending'; // 'win', 'loss', 'pending'
$pnl       = floatval($input['pnl'] ?? 0);      // negative value = loss
